...
namespace APICatalogo.Controllers
{
    ...
    public class ProdutosController : ControllerBase
    {
        ...
        public ActionResult<IEnumerable<Produto>> Get()
        {
            ...
            if(produtos is null)
            {
                return NotFound(""); //Equivale ao erro 404
            }
            return Ok(produtos);
        }

        //[HttpGet("{id:int:min(1)}", Name ="ObterProduto")] // O valor minimo que pode receber é 0
        ...
        public ActionResult Delete(int id)
        {
            ...
            return Ok($"Produto Deletado: {produtoDeletado}");
        }
    } 
} 